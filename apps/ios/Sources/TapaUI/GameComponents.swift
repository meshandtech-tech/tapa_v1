...
/// Animated presentation of an already-authoritative winner. The animation is
/// decorative: `winnerID` always comes from the Supabase snapshot.
struct PlayerSpinner: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("\(title): \(displayedName)")
    }
}
